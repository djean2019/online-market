...
module.exports = {
    populateUsers: function (onComplete) {
        ...
        let user1 = new UserModel({ 
          ...
          fullname: 'Joanne H. J.', email: 'joanne@onlinemarket.com', 
          password: bcrypt.encodeSync('1234'), 
          role:'SELLER' });

        let user2 = new UserModel({ 
          "_id":mongoose.Types.ObjectId("5eeb587c2d00fe19cf34b4d3"),
          fullname: 'Longxiang X.', email: 'caleb@onlinemarket.com', 
          password: bcrypt.encodeSync('1234'), role:'BUYER' });

        let user3 = new UserModel({ 
          "_id":mongoose.Types.ObjectId("5eeb587c2d00fe19cf34b4d4"),
        fullname: 'Benssy H. J.', email: 'benssy@onlinemarket.com', 
        password: bcrypt.encodeSync('1234'), role:'SELLER' });

        let user4 = new UserModel({ 
          "_id":mongoose.Types.ObjectId("5eeb587c2d00fe19cf34b4d5"),
          fullname: 'Blanco T.', email: 'blanco@onlinemarket.com', 
          password: bcrypt.encodeSync('1234'), 
          role:'BUYER', 
        address:[
            {
    ...
    populateProduct: function (onComplete) {
        let pro1 = new ProductModel({ 
          ...
          name: 'Angular', price: 30, 
          imageUrl: 'https://www.levelaccess.com/wp-content/uploads/2015/08/AngularJS_google.png', 
          description: 'This is a nice book',
           userId:'5eeb587c2d00fe19cf34b4d2' });

        let pro2 = new ProductModel({ "_id":mongoose.Types.ObjectId("5eeb9315af3c3b2bca59ffa5"), 
        name: 'Node Js', 
        price: 70, 
        ...
        let pro4 = new ProductModel({ 
          ...
          name: 'Spring', 
          price: 100, 
          imageUrl: 'https://miro.medium.com/max/550/1*47DZV2oA3VWB-AaZOIT73w.png', description: 'A better way to improve your app', userId: '5eeb587c2d00fe19cf34b4d2' })
